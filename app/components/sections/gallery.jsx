...
function Gallery() {
  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 xl:py-[96px] flex flex-col w-full px-4 sm:px-6 md:px-8">
      ...
      <button className="mt-8 sm:mt-12 md:mt-16 lg:mt-[64px] font-semibold mx-auto text-xs sm:text-sm w-fit rounded-[48px] text-white p-2 sm:p-[10px_20px_10px_20px] md:p-[12px_24px_12px_24px] bg-[#37A16C] border-[#36BD79] border">
        {t("button")}
      </button>
    </section>
  );
